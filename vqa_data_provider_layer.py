...
class VQADataProvider:
    ...
    def create_batch(self,qid_list):
        ...
        dis_lab = (np.zeros(self.batchsize)).reshape(self.batchsize)
        ...
        for i,qid in enumerate(qid_list):
            ...
            # dis_lab[i,...] = np.ones(self.batchsize)
            dis_lab[i,...] = 1

        return qvec, cvec, ivec, avec, exp_vec, exp_vec_out, exp_cvec_1, exp_cvec_2, dis_lab
...
class VQADataProviderLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        self.top_names = ['data','cont','feature', 'label', 'exp', 'exp_out', 'exp_cont_1', 'exp_cont_2', 'dis_label']
    ...
    def forward(self, bottom, top):
        if self.mode == 'val' or self.mode == 'test-dev' or self.mode == 'test':
            ...
            word, cont, feature, answer, exp, exp_out, exp_cont_1, exp_cont_2, dis_label, _, _, _ = self.dp.get_batch_vec()
            ...
            top[8].data[...] = np.transpose(dis_label)
