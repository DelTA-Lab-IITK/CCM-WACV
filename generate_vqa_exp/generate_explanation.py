...
def main():
    ...
    parser.add_argument('--ques_file', help='vqa question file', default='../../MultimodalExplanations/PJ-X-VQA/VQA-X/Questions/v2_OpenEnded_mscoco_val2014_questions.json')
    parser.add_argument('--ann_file', default='../../MultimodalExplanations/PJ-X-VQA/VQA-X/Annotations/v2_mscoco_val2014_annotations.json')
    parser.add_argument('--exp_file', default='../../MultimodalExplanations/PJ-X-VQA/VQA-X/Annotations/val_exp_anno.json')
    parser.add_argument('--gpu', type=int, default=0)
    parser.add_argument('--out_dir', default='../VQA-X/Results')
    parser.add_argument('--folder', help='folder containing model', default='../model')
    parser.add_argument('--model_path', help='path to caffemodel',default='../snapshots1/VQA-X/generator_model_iter_10000.caffemodel')
    ...
    parser.add_argument('--img_feature_prefix', default='../../MultimodalExplanations/PJ-X-VQA/VQA-X/Features/resnet_res5c_bgrms_large/val2014/COCO_val2014_')
